...
function get_rule(brel) {
    ...
    ret.fwd_min_stay = undefined;
    ret.fwd_max_stay = undefined;
    ...
    if (stay) {
        for (i = 0; i < stay.length; i++) {
            ...
            } else if (stay_mmt === 'SetForwardMinStay') {
                if (ret.fwd_min_stay === undefined) {
                    ret.fwd_min_stay = Number(stay_t);
                } else {
                    throw 'invalid BookingRule: more than on LengthOfStay of type "SetForwardMinStay"';
                }
            } else if (stay_mmt === 'SetForwardMaxStay') {
                if (ret.fwd_max_stay === undefined) {
                    ret.fwd_max_stay = Number(stay_t);
                } else {
                    throw 'invalid BookingRule: more than on LengthOfStay of type "SetForwardMaxStay"';
                }
            } else {
